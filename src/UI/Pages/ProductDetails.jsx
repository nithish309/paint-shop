...
const ProductDetails = ({ products,theme }) => {
    ...
    <div>
      <section className="lora-regular lg:mt-10 mt-5 lg:mb-10 mb-5 lora-regular ml-3 mr-3" >
        ...
        <div className="card-body items-center text-center">
          ...
          <p className="lg:mt-4 mt-0 text-md text-gray-600 lg:text-lg text-justify ml-3 mr-3" style={{  backgroundColor: theme === 'light' ? 'white' : '#333', 
