        ...
        <div className='hero min-h-screen' style={{  backgroundColor: theme === 'light' ? 'white' : '#333', 
          ...
          <div className="hero-content" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', width: '100%' }}>
            ...
            <div className='max-w-md' style={{ transform: reveal && !isMobile ? 'translateX(-20%)' : 'translateX(0)', transition: 'transform 0.8s ease-in-out', textAlign: 'left' }}>
              <h1 className="text-3xl font-bold lg:text-5xl lg:font-bold">Welcome</h1>
              <h3 className="text-xl font-medium mt-3 lg:text-3xl lg:font-medium">NK PAINT'S WORLD</h3>
              <h6 className="text-base font-bold mt-3 lg:text-xl lg:font-bold">Quality First Cash Next</h6>
              <p className="py-6 text-sm lg:text-base text-justify">
                NK Paint's is a local paint shop offering a wide range of high-quality paints for residential, 
                commercial, and industrial purposes. Known for its expert advice and personalized service, 
                NK Paint's provides customers with premium brands, custom color matching, and all the tools needed for any painting project.
              </p>
              <Link to="/products">
