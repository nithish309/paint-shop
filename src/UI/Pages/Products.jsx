...
const Products = ({ setCartItems, theme, refreshTrigger }) => {
    ...
    <div>
      ...
      >
        ...
        {loading ? (
          ...
          <p className="text-center mt-10 font-bold lg:text-2xl text-lg">{error}</p>
        ) : (
                ...
                >
                  ...
                  <div className="card-body items-center text-center">
                    ...
                    <div className="card-actions mt-2 flex justify-between items-center">
                      <Link to={`/product/${product._id}`} className="btn btn lora-regular">
                        View
                      </Link>
                      <button
